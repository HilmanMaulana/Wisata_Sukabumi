                    ...
                    <tr>
                        ...
                        <td>
                            <picture>
                                ...
                                <img src="<?= base_url('assets/img/upload/') . $ws['image'];?>" class="img-fluid img-thumbnail" alt="..." width="150px">
                            </picture></td>
                        <td>
                            <a href="<?= base_url('wisata/ubahWisataSejarah/').$ws['id'];?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
                            <a href="<?= base_url('wisata/hapuswisataSejarah/').$ws['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.' '.$ws['nama_wisata'];?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="wisataBaruModalLabel">Tambah Tempat Wisata Sejarah</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('wisata/wisata_sejarah'); ?>" method="post" enctype="multipart/form-data">
